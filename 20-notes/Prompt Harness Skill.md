...
**Install:** copy the fenced block below into `~/.claude/skills/harness/SKILL.md` on any machine (user-global; available in every project). Local source of truth: that same path on the MacBook.
