...
- [[Choices Cost Snapshot 2026-07]] — live scan + post-PAYG steady-state estimate (≈$14–18/mo, WAF-dominated) + savings levers
- [[Austin Voice Pack]] — verbatim writing samples + edit-diff loop so LLM blog drafts sound like Austin (loaded by every stage-2 drafting run)
